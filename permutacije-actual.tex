...
Da je pogojno divergentna, pa sledi iz dejstva, da obstaja pogojno konvergentna vrsta $$\sum_{n=1}^{\infty}(-1)^n\frac{1}{n},$$ sestavljena iz popolnoma enakih členov kot vrsta (\ref{eq:6}). Ta konvergira po testu za alternirajoče vrste. %sklicevanje na ta test?
...
%razloži vzorec te vrste
Trdimo, da za vsako število $L\in \mathbb{R}$ obstaja $\lambda$-permutacija, ki iz zgornje (divergentne) vrste ustvari konvergentno vrsto z vsoto $L$, torej da je za to vrsto $S=\mathbb{R}$.
%povej, zakaj je divergentna
%lambda permutacija, ki jo preoblikuje v konvergentno
